    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md glass-strong rounded-2xl p-8 animate-slide-up">
        <div className="text-center mb-6">
          <div className="w-14 h-14 rounded-2xl bg-brand-gradient mx-auto mb-4 flex items-center justify-center font-bold text-2xl text-white animate-pulse-glow">
            R
          </div>
          <h1 className="text-2xl font-bold text-gradient">Welcome to Resonance</h1>
